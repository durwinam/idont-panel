...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_dev() {
    ...
    XUI_UPDATE_TAG="dev-latest" bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/durwinam/idont-panel/main/x-ui.sh" "false"; then
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    if replace_xui_script "https://github.com/durwinam/idont-panel/raw/main/x-ui.sh" "true"; then
...
show_menu() {
    echo -e "
╔────────────────────────────────────────────────╗
│  ${green}idont-panel Panel Management Script${plain}                │
