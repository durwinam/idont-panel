...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/durwinam/idont-panel.svg" alt="GO Version"></a>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/master/install.sh)
```

برای نصب یک نسخه‌ی مشخص، تگ آن را در انتها اضافه کنید (مثلاً `v3.4.0`):

```bash
bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/master/install.sh) v3.4.0
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/durwinam/idont-panel/master/install.sh) dev-latest
```
